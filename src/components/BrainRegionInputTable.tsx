...
const BrainRegionInputTable: React.FC<BrainRegionInputTableProps> = ({
  ...
  <div className="space-y-2 mt-6 w-full">
    <div className="grid grid-cols-12 gap-3 font-bold text-sm bg-gray-100 p-3 rounded w-full">
      ...
      <div className="col-span-1.75 text-center">Left (cm³)</div>
      <div className="col-span-1.75 text-center">Right (cm³)</div>
      <div className="col-span-1.25 text-center">Total (cm³)</div>
      <div className="col-span-1.75 text-center">Norm (cm³)</div>
